...
local crater = {
  ...
  cliffs = { -- list of cliffs, visual variance shall be checked automatically
    ...
    -- the X is always even, Y is always even +0.5, dont worry about the reference point issues if the values are odd, system shall try to spawn at appropriate position
